...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (!args[0]) {
        ...
        let respondA = ["how may I help you?", "how can I help?", "I'm a 𝐗𝐍𝐈𝐋, a Large Language Model Artificial Intelligence, how may I help you?", "do you need help?"];//dagdagan mo din to
